// src/pages/inventory/pos/index.tsx - UPDATED WITHOUT REACT-ROUTER-DOM
...
export default function PointOfSalePage() {
  ...
  const updateOrderQuantity = (itemId: number, quantity: number) => {
    if (quantity === 0) {
      ...
      setOrderItems((prevOrder) => prevOrder.map((item) => (item.id === itemId ? { ...item, orderQuantity: quantity } : item)));
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Click on any item to add to order
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-center z-10">
                          <Badge
                            variant={
                              itemData.quantity === 0 ? "destructive" : 
                              itemData.quantity < 5 ? "warning" : 
                              "secondary"
                            }
            ...
            <CardContent className="space-y-6">
              ...
              {orderItems.length === 0 ? (
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  {orderItems.map((item) => (
                    <div key={item.id} className="flex items-center justify-between p-3 border-2 border-black rounded-xl">
