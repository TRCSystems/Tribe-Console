        ...
        <div className="space-y-6 pb-10">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                    <Select value={status} onValueChange={(newStatus) => { setStatus(newStatus); setPage(0); }}>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                            <div className="flex items-end gap-2">
                                <div className="space-y-1">
                                    <Label htmlFor="startDate" className="text-xs font-medium text-slate-700">From</Label>
                                    <Input
                                        id="startDate"
                                        type="date"
                                        value={startDate}
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="endDate" className="text-xs font-medium text-slate-700">To</Label>
                                    <Input
                                        id="endDate"
                                        type="date"
                                        value={endDate}
                            ...
                            <div className="rounded-2xl border border-slate-200">
                                ...
                                <div className="divide-y divide-slate-200">
                                    {selectedOrder.items.map((item) => (
                                        <div
                                            key={item.id}
                                            className="grid gap-4 px-4 py-4 sm:grid-cols-[1.4fr_0.6fr_0.8fr_0.8fr]"
                                        >
                                            <div>
